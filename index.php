...
<html>
	<head>
		<title>Entrepreneurship Foundation Program</title>
		<meta charset="utf-8" />
				...
				<div class="inner">
					...
					<nav id="nav">
						...
						<div class="dropdown">
							...
							<a href="#tab1" style="padding: 0px; margin: 0px;">Overview</a>
							<a href="#tab2" style="padding: 0px; margin: 0px;">Module</a>
							<a href="#tab4" style="padding: 0px; margin: 0px;">What will you get</a>
							<a href="#tab3" style="padding: 0px; margin: 0px;">Fees Structure</a>
							</div>
						</div>
...
<div class="container slideContainertop" style="width: 100%;">
	...
	<div class="row" style="width: 100%; margin: 0px 0px 0px 0px;">
								...
								<div style="width: 100%; background-color: rgb(241, 241, 241); left: 0em; height: 45em;" class="swiperContainer swiperContainer2">
    ...
    <!-- Add Arrows -->
    <div class="swiper-button-next swiper-button-white next2"></div>
    <div class="swiper-button-prev swiper-button-white prev2"></div>
  </div>
		...
		<!-- Three -->
		<div style="position: relative;top: -1em;" id="navTab"></div>
					...
					<div class="flex flex-2">
						...
						<!-- <div class="mainNav" >
						    <ul class="nav nav-tabs">
						        <li class="active">
						            <a href="#tab1">About The Program</a>
						        </li>
						        <li>
						            <a href="#tab2">Program Module</a>
						        </li>

						        <li>
						            <a href="#tab4">What Will You Get</a>
						        </li>
						        <li>
						            <a href="#tab3">Fees Structure</a>
						        </li>
						    </ul>
						</div> -->
...
<div class="o-video">
	<iframe src="https://www.youtube.com/embed/rdLCSee45ck" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen style="width: 100%; height: 100%;"></iframe>
						...
						<section id="tab2" class="tab-content ">
								<div id="progMod">
									<h2 style="font-weight: 600; text-align: left; font-size: 3em;">Program Module</h2><!-- 
							    	<div class="modList">
							    		<div class="modCircle"></div>
							    		<p>Build a Balanced Founding Team</p>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    	...
							    	<div class="modList">
							    		<div class="modCircle"></div>
							    		<p>Sharpen your Problem Pitch</p>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    	...
							    	<div class="modList">
							    		<div class="modCircle"></div>
							    		<p>Iterate on your MVP to create an MLP</p>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    	...
							    	<div class="modList">
							    		<div class="modCircle"></div>
							    		<p>Identify and Define your Market</p>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    	...
							    	<div class="modList">
							    		<div class="modCircle "></div>
							    		<p>Identify and Prioritize your Riskiest Assumptions and the Factors that may affect these risks</p>
							    		<div class="modDot dotP2"></div>
							    		<div class="modDot dotP2"></div>
							    		<div class="modDot dotP2"></div>
							    		<div class="modDot dotP2"></div>
							    		<div class="modDot dotP2"></div>
							    	...
							    	<div class="modList">
							    		<div class="modCircle"></div>
							    		<p>Create experiments to mitigate risks posed by risky assumptions</p>
							    		<div class="modDot l2"></div>
							    		<div class="modDot l2"></div>
							    		<div class="modDot l2"></div>
							    		<div class="modDot l2"></div>
							    		<div class="modDot l2"></div>
							    	...
							    	<div class="modList">
							    		<div class="modCircle"></div>
							    		<p>Conducting Customer Conversation</p>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
							    		<div class="modDot"></div>
						    	 ...
						    	 <div style="float: left; font-size: 1.5em; font-weight: 1000;">
						    	 	Week 1
						    	 </div>
						    	 ...
						    	 <img src="images/Rectangle_745@2x-min.png" id="progBar">
						    	   ...
						    	   <div class="grid progCol">
								    ...
								    <div class="cg-1-6">Identify and prioritize your riskiest assumptions</div>
								    <div class="cg-1-6">Craft your customer persona</div>
								    <div class="cg-1-6">Define your minimum "Lovable" product-minimum viable product</div>
								    <div class="cg-1-6">Pitch perfect - Elevator pitch</div>
								    <div class="cg-1-6">How to raise your first investment</div>
								  </div>
						    	 </div>
<!-- 						    	<div class="detailsColumn">

									<h4><b>Program starts from</b></h4>
									<p><b>November/December 2019</b></p>
									<h4><b>Duration</b></h4>
									<p><b>6 Weeks</b></p>
									<h4><b>Workshops</b></h4>
									<p><b>Fri: 4pm to 7pm 
Sat: 4pm to 7pm</b></p>
									<h4><b>Fees</b></h4>
									<p><b>INR 25,000*</b></p>
									<p id="taxID">* exclusive of all taxes</p>
									<button class="enrollBtn">ENROLL NOW</button>
							</div> -->
						    
						</section>
						
						<section id="tab3" class="tab-content container" style="margin-top: 10em;">
							
							<div class="row" style="margin: 0px 0px 0px 0px !important;">
								<!-- <div class="detailsColumn">

									<h4><b>Program starts from</b></h4>
									<p><b>6<sup>th</sup>December 2019</b></p>
									<h4><b>Duration</b></h4>
									<p><b>6 Weeks</b></p>
									<h4><b>Fees</b></h4>
									<p><b>INR 25,000*</b></p>
									<p id="taxID">* inclusive of all taxes</p>
									<button class="enrollBtn">ENROLL NOW</button>
							</div> -->
								<div class="feeStruct">
									<div class="feeDetails">
										<h2 style="font-weight: 600; margin: 0px; margin-top: 0.5em; text-align: left; font-size: 3em;">Fee Structure</h2>
										<div style="width: 30%; height: 40%; float: left;">
											<h4><b>Program starts from</b><br>
6<sup>th</sup> December 2019</h4>
										</div>
										<div style="width: 30%; height: 40%; float: right;">
											<h4><b>Fees</b><br>
INR 25,000*</h4><br><p style="position: relative;
    top: -3.5em;">*Inclusive of taxes</p>
										</div>
...
<!-- 						    <div>
								  ...
								  <div class="column"><img class="columnImages" src="images/ID5d848232073ec_A2_Rectangle_77_pattern.png">
								  	<h4>Custom Designed for the first-time entrepreneur</h4></div>
								  <div class="column"><img src="images/ID5d84812c599a9_A9_Rectangle_305_pattern.png" class="columnImages">
								  <h4>Programme developed by veteran entrepreneurs and investors who know what it takes to run sustainable and scalable ventures.</h4></div>
								  <div class="column"><img src="images/ID5d84816e54144_A9_Rectangle_307_pattern.png" class="columnImages">
								  	<h4>Our team understand what it means to be investment-ready as you design your venture</h4></div>
								</section>

								<section class="sectionFlex">
								  <div class="column"><img src="images/ID5d84809bb768a_A9_Rectangle_303_pattern.png" class="columnImages">
								  	<h4>Hands-on experiential workshops to validate your ideas.
</h4></div>
								  <div class="column"><img src="images/ID5d848033adb10_A2_Rectangle_79_pattern.png" class="columnImages">
								  	<h4>Network with fellow entrepreneurs, mentors and investors from the startup ecosystem in India and USA.</h4></div>
								</section>
						    </div> -->
						...
						<section id="tab4" class="tab-content" style="margin-top: 10em;">
							<h2 style="font-weight: 600; text-align: left; font-size: 3em;">What Will You Get</h2>
<!-- 						    <div>
						        <section class="sectionFlex">
								  <div class="column"><img class="columnImages" src="images/ID5d848232073ec_A10_Rectangle_330_pattern.png">
								  	<h4>One-on-one mentor sessions with Industry Experts</h4></div>
								  <div class="column"><img src="images/ID5d84812c599a9_A3_Rectangle_116_pattern.png" class="columnImages">
								  <h4>40+ Hours of Online Learning</h4></div>
								  <div class="column"><img src="images/ID5d84816e54144_A10_Rectangle_340_pattern.png" class="columnImages">
								  	<h4>Relevant Case Studies and Assignments</h4></div>
								</section>
								<section class="sectionFlex">
								  <div class="column"><img class="columnImages" src="images/ID5d84809bb768a_A10_Rectangle_336_pattern.png">
								  	<h4>Personalised Feedback on Assignments</h4></div>
								  <div class="column"><img src="images/ID5d848033adb10_A2_Rectangle_79_pattern.png" class="columnImages">
								  <h4>Access to offline and online workshops</h4></div>
								  <div class="column"><img src="images/ID5d848033adb10_A10_Rectangle_334_pattern.png" class="columnImages">
								  	<h4>Capria VentureBasecamp frameworks, toolkits and canvases for each topic.</h4></div>
								</section>
						    </div> -->
...
<div class="wrapper" style="margin-top: 0px;">
  ...
  <figure class="flip-box">
    <div class="flip">
      ...
      <!-- Back -->
      <div class="back red">
        <span class="icon">40+ Hours of Online Learning</span>
      </div>
    </div>
  </figure>
    ...
    <div class="flip">
      ...
      <!-- Back -->
      <div class="back red">
        <span class="icon">Relevant Case Studies and Assignments</span>
      </div>
    </div>
  </figure>
...
<!-- 
    ...
    <div class="cg-1-3">
    	<img class="columnImages" src="images/ID5d848232073ec_A10_Rectangle_330_pattern.png">
								  	<h4>One-on-one mentor sessions with Industry Experts</h4>
    </div>
    <div class="cg-1-3">
    	<img src="images/ID5d84812c599a9_A3_Rectangle_116_pattern.png" class="columnImages">
								  <h4>40+ Hours of Online Learning</h4>
    </div>
    <div class="cg-1-3">
    	<img src="images/ID5d84816e54144_A10_Rectangle_340_pattern.png" class="columnImages">
								  	<h4>Relevant Case Studies and Assignments</h4>
    </div>

        <div class="cg-1-3">
    	<img class="columnImages" src="images/ID5d84809bb768a_A10_Rectangle_336_pattern.png">
								  	<h4>Personalised Feedback on Assignments</h4>
    </div>

        <div class="cg-1-3">
    	<img src="images/ID5d848033adb10_A2_Rectangle_79_pattern.png" class="columnImages">
								  <h4>Access to offline and online workshops</h4>
    </div>

        <div class="cg-1-3">
    	<img src="images/ID5d848033adb10_A10_Rectangle_334_pattern.png" class="columnImages">
								  	<h4>Capria Venture Basecamp frameworks, toolkits and canvases for each topic.</h4>
    </div>
						...
						<section class="midPage">
							<h1>Who Is It For?</h1>
							<p>Working Professionals, Entrepreneurs, SMEs, Students</p>
							<div class="innerMidPage">

							</div>
						    	
						</section>
	<section class="container instructors" id="instructorsRef">
		<h2 style="font-size: 3em; font-weight: 600; text-align: left;">Instructors</h2>
		<div class="row ">
			<div class="col-3 headerBlk1" >
				<h2>Online Instructor</h2>
			</div>
			<!-- <div class="col-3"></div> -->
			<div class="col-3 headerBlk2">
				<h2>Classroom Session Instructors</h2>
			</div>
		</div>
      <div class="row ">
          <div class="col-3 seperatorVertical tabInstructors popup" onclick="myFunction1()">
              <!-- <h2>Online Instructor</h2> -->
          ...
          <div class="col-3 tabInstructors popup" onclick="myFunction4()">
              ...
              <img src="images/RAZDNnos_400x400.png" id="cirImg">
  ...
  <section class="container textData">
  	<hr>
  	<div class="row endText1">
  		<br> <br> <br> 
  		<h2 style="padding-left: 1em;">About CIBA</h2>
...
<!-- 						<article>
						...
						<div class="container swiperContainer swiperContainer1">
							<br><br>
							<h2>What startups say</h2>
							<br><br>
							<div class="row">
								    ...
								    <div class="swiper-wrapper">
								        ...
								        <div class="swiper-slide">
								        	...
								        	<div class="swiperDetails">
								        		<p>“It provided an interactive framework for trying out our ideas, getting ideas from others, calibrating our approach and capabilities, and offered greater insights into the multiple dimensions of a startup. It offered a structured way of covering all aspects of the start-up - a comprehensive framework.”</p>
								        		<h3>Sundararajan S</h3>
								        		<h4>CEO, Ubiqare Health</h4>
								        	</div>
								        ...
								        <div class="swiper-slide">
								         ...
								         <div class="swiper-slide">
								        	...
								        	<div class="swiperDetails">
								        		<p>"The online curriculum is highly interactive and engaging and made us a team look at things with a much more objective outlook as compared to the thinking by ourselves. A lot of startup Jargons MVP, Product -Market fit, etc became more familiar and helped steer the thought process when we found ourselves stuck at a crossroad."</p>
								        		<h3>Prajwal Ajay</h3>
								        		<h4>CEO, Gordian Tech</h4>
								        	</div>
								        </div>
								        ...
								        <!--
								        <div class="swiper-slide">
								        	<img src="images/Ellipse_4_A4_Ellipse_115_pattern.png" class="imageSlide">
								        	<div class="swiperOverlay">
								        ...
								        <div class="swiper-slide">
								        	...
								        	<div class="swiperDetails">
								        		<p>HERELorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
								        		<h3>John Doe</h3>
								        		<h4>CEO</h4>
								        	</div>
								        </div> -->
						...
						<!-- <div class="container newsletter">
							<div class="row">
								...
								<input class="subscription" type="email" name="Email">
								<button class="newsSign">Sign Up</button>
							</div>
						</div> -->
						<!-- <div id="map"></div> -->


<script type="text/javascript" src="https://adsl.maillist-manage.com/js/optin.min.js" onload="setupSF('sfd1435fc1a877f318ebd8fffe3b3671d6c98e811ca5f0889b','ZCFORMVIEW',false,'light')"></script>
<script type="text/javascript">
	function runOnFormSubmit_sfd1435fc1a877f318ebd8fffe3b3671d6c98e811ca5f0889b(th){
...
<style>
        ...
        @media only screen and (max-width: 200px) {
            .quick_form_6_css[name='SIGNUP_BODY'] {
                width: 100% !important;
...
<div id="sfd1435fc1a877f318ebd8fffe3b3671d6c98e811ca5f0889b" data-type="signupform" style=" width: 100%;">
	<div id="customForm" >
		<div class="quick_form_6_css newsContainer" style="background-color:rgb(42, 43, 44);z-index:2;font-family:'Arial';border: 1px solid rgb(206, 206, 206);overflow: hidden;" name="SIGNUP_BODY">
			<div>
				<span style="font-size: 1.5em;font-family:'Arial';font-weight: bold;color: white;text-align: left;margin: 15px 15px 5px;width:100%;display:block;" id="SIGNUP_HEADING">Join Our Newsletter</span>
					...
					<div id="Zc_SignupSuccess" style="display:none;position:absolute;margin-left:4%;width:90%;background-color: white; padding: 3px; border: 3px solid rgb(194, 225, 154);  margin-top: 10px;margin-bottom:10px;word-break:break-all">
						<table width="100%" cellpadding="0" cellspacing="0" border="0">
							<tbody>
								<tr>
									<td width="10%">
										<img class="successicon" src="https://adsl.maillist-manage.com/images/challangeiconenable.jpg" align="absmiddle">
									</td>
									<td>
				...
				<form method="POST" id="zcampaignOptinForm" style="margin:0px;width:100%;text-align: center;" action="https://maillist-manage.com/weboptin.zc" target="_zcSignup">
					<div style="background-color: rgb(255, 235, 232); padding: 10px; color: rgb(210, 0, 0); font-size: 11px; margin: 20px 10px 0px; border: 1px solid rgb(255, 217, 211); opacity: 1; display: none;" id="errorMsgDiv">Please correct the marked field(s) below.</div>
					<div style="position:relative;width: 170px;height: 28px;display: inline-block;">
						...
						<span style="padding:5px 0px;color: white;font-size: 12px;font-family: Arial;display:block;text-align: left;">Email</span>
						<input type="text" style="font-size: 12px;border-width: 1px;border-color:rgb(214, 205, 205);border-style:solid;width:100%;height:100%;z-index:4;outline:none;padding: 5px 10px;color:white;text-align:left;font-family:'Arial';border-radius:4px;background-color:#f6f6f6; background: none !important;
	border: none !important;
	border-bottom: 2px solid white !important;" changeitem="SIGNUP_FORM_FIELD" name="CONTACT_EMAIL" id="EMBED_FORM_EMAIL_LABEL">
					</div>
					<div style="position:relative;margin: 5px 0 40px 10px;width:170px;height:28px;display: inline-block;">
						<span style="padding: 5px 0px;color: white;font-size: 12px;font-family: Arial;display:block;text-align: left;">Name</span>
						<input type="text" style="font-size: 12px;border-width: 1px;border-color:rgb(214, 205, 205);border-style:solid;width: 100%;height: 100%;z-index:4;outline:none;padding: 5px 10px;color:white;text-align:left;font-family:'Arial';border-radius:4px;background-color:#f6f6f6; background: none !important;
	border: none !important;
	border-bottom: 2px solid white !important;" changeitem="SIGNUP_FORM_FIELD" name="LASTNAME" id="EMBED_FORM_NAME_LABEL">
					</div>
					<div style="margin: 0 0 15px 12px;display: inline-block;">
						<input type="button" style="text-align:center;width:5em;height:100%;z-index:5;border:0;color:#ffffff;cursor: pointer;outline:none;font-size: 14px;border-radius: 1px;border-radius:5em; width: 12em !important;
	background-color: rgb(0, 164, 255); text-align: center;" name="SIGNUP_SUBMIT_BUTTON" id="zcWebOptin" value="Join Now">
					</div><!-- Do not edit the below Zoho Campaigns hidden tags -->
					<input type="hidden" id="fieldBorder" value="">
					<input type="hidden" id="submitType" name="submitType" value="optinCustomView">
					<input type="hidden" id="emailReportId" name="emailReportId" value="">
					<input type="hidden" id="formType" name="formType" value="QuickForm">
					<input type="hidden" name="zx" id="cmpZuid" value="1265ed031">
					<input type="hidden" name="zcvers" value="3.0">
					<input type="hidden" name="oldListIds" id="allCheckedListIds" value="">
					<input type="hidden" id="mode" name="mode" value="OptinCreateView">
					<input type="hidden" id="zcld" name="zcld" value="167c6e89ecc1ca02">
					<input type="hidden" id="document_domain" value="">
					<input type="hidden" id="zc_Url" value="adsl.maillist-manage.com">
					<input type="hidden" id="new_optin_response_in" value="0">
					<input type="hidden" id="duplicate_optin_response_in" value="0">
					<input type="hidden" name="zc_trackCode" id="zc_trackCode" value="ZCFORMVIEW" onload="">
					<input type="hidden" id="zc_formIx" name="zc_formIx" value="d1435fc1a877f318ebd8fffe3b3671d6c98e811ca5f0889b"><!-- End of the Zoho Campaigns hidden tags -->
	...
	<img src="https://adsl.maillist-manage.com/images/spacer.gif" id="refImage" onload="referenceSetter(this)" style="display:none;">
</div>
<input type="hidden" id="signupFormType" value="QuickForm_Horizontal">
<div id="zcOptinOverLay" oncontextmenu="return false" style="display:none;text-align: center; background-color: rgb(0, 0, 0); opacity: 0.5; z-index: 100; position: fixed; width: 100%; top: 0px; left: 0px; height: 988px;"></div>
<div id="zcOptinSuccessPopup" style="display:none;z-index: 9999;width: 800px; height: 40%;top: 84px;position: fixed; left: 26%;background-color: #FFFFFF;border-color: #E6E6E6; border-style: solid; border-width: 1px;  box-shadow: 0 1px 10px #424242;padding: 35px;">
	<span style="position: absolute;top: -16px;right:-14px;z-index:99999;cursor: pointer;" id="closeSuccess">
		<img src="https://adsl.maillist-manage.com/images/videoclose.png">
	</span>
...
<!-- 			<div class="container">
				<div class="row mapIcons">
					<div class="col-3 geoLoc">
						<img src="images/location_A0_Rectangle_18_pattern.png">
						<p>CIBA
...
Vashi, Navi Mumbai 
					...
					<div class="col-3 geoLoc">
						<img src="images/message_A0_Rectangle_20_pattern.png">
						<p>Mumbai@ciba.org.in
sagar.chandni@ciba.org.in</p>
					</div>
					<div class="col-3 geoLoc">
						<img src="images/phone_A0_Rectangle_22_pattern.png">
...
<input type="text" compname="PhoneNumber_countrycodeval" name="PhoneNumber_countrycodeval" phoneFormat="1" maxlength="10"  id="international_PhoneNumber_countrycodeval" placeholder="Country Code" />
...
<button type="submit" class="contactBtn"><em>Submit</em></button></form> -->
					...
					<div id="mapdiv" style="background-image: url('images/mapNew.png'); background-size: cover; background-repeat: no-repeat; background-position: center;"></div>
...
<footer class="footerMain" id="footref">
...
sagar.chandni@ciba.org.in</p>
				...
				<div class="footer-list">
					...
					<!-- <div class="col-3"><a href="http://ciba.org.in/mumbai">About CIBA</a></div>
        
			        <div class="col-3"><a href="https://venturebasecamp.co/">About Capria Venture Basecamp</a></div>
			        
			        <div class="col-3"><a href="http://ciba.org.in/mumbai/blog">CIBA (Blog)</a></div>
			     <div class="col-3"><a href="http://ciba.org.in/mumbai/blog">12 Critical Success Elements</a></div> -->
				</div>
...
<!-- <footer>
  <div class="container text-left footerMain">
    <div class="row">
...
<!-- 			
    ...
    var lonLat = new OpenLayers.LonLat( 72.991730 , 19.076000)
          .transform(
...
<!-- 			    <script>
			// Initialize and add the map
					function initMap() {
					  ...
					  var uluru = {lat: 19.076000, lng: 72.991730};
        ...
        <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAWucPBM0ikp-Y-Oxs6UlT0Qp3WqSyLEnc&callback=initMap">
    </script> -->
			<script>
...
<!--     <h2 class="fs-title">Personal Details</h2>
    ...
    <label>Name of your venture</label>
    <input type="text" name="Company" />
    <label>Email ID</label>
    <input type="email" name="email" />
    <label>Phone Number</label>
    <input type="tel" name="phone" />
    <label>Domain you are working on</label>
...
<!--   <fieldset>
    ...
    <h3 class="fs-subtitle">Choose payment method below</h3>
